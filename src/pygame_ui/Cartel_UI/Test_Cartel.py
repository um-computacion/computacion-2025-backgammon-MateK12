...
class TestCartel(unittest.TestCase):
    ...
    def test_mostrar_cartel(self):
        self.cartel.mostrar_cartel("Test Message", duracion=2.0, titulo="Test",color_fondo=(1,1,1),color_texto=(1,1,1))
        ...
        self.assertEqual(self.cartel._Cartel_UI__color_fondo,(1,1,1))
        self.assertEqual(self.cartel._Cartel_UI__color_texto,(1,1,1))
        self.assertTrue(self.cartel.mensaje_activo)

    def test_dibujar_mensaje_se_llama_si_activo(self):
        self.cartel.mostrar_cartel("Mensaje de prueba", duracion=5.0, titulo="Test",color_fondo=(1,1,1),color_texto=(1,1,1))
    ...
    def test_dibujar_mensaje_no_se_llama_si_expirado(self):
        self.cartel.mostrar_cartel("Mensaje corto", duracion=3, titulo="Test",color_fondo=(1,1,1),color_texto=(1,1,1))
        time.sleep(3.1)
        with patch.object(self.cartel, "_Cartel_UI__dibujar_mensaje") as mock_dibujar:
            self.cartel.actualizar_y_dibujar(self.screen)
            mock_dibujar.assert_not_called()
    ...
    def test_dibujar_cartel(self, mock_draw_rect):
        ...
        self.cartel.mostrar_cartel("Test mensaje", duracion=5.0, titulo="Test Titulo",color_fondo=(1,1,1),color_texto=(1,1,1))
