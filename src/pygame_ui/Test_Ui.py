...
class Test_Ui(unittest.TestCase):
    ...
    def test_puede_hacer_algun_movimiento_false(self):
        ...
        self.mock_backgammon.puede_mover_ficha = MagicMock(
            side_effect=NingunMovimientoPosible
        )
    ...
    def test_mostrar_ganador_loop_actualiza_hasta_timeout(
        self, mock_event_get, mock_clock_cls, mock_get_ticks
    ):
    ...
    @patch("src.pygame_ui.ui.pygame.time.Clock")
    @patch("src.pygame_ui.ui.pygame.event.get")
    def test_mostrar_ganador_loop_actualiza_hasta_timeout_Negro(
        self, mock_event_get, mock_clock_cls, mock_get_ticks
    ):
