...
class TableroUI():
    ...
    def dibujar_tablero(self,screen):
            ...
            """
            pygame.draw.rect(screen, BLACK, (self.__x__, self.__y__, self.__ancho_tablero__, self.__alto_tablero__), 3) # Borde del tablero
            
            bar_x = self.__x__ + self.__ancho_tablero__ // 2 - 25
            pygame.draw.rect(screen, DARK, (bar_x, self.__y__, 50, self.__alto_tablero__)) #barra del medio divisoria
