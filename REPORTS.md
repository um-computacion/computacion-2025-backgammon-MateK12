...
src/pygame_ui/CamposUI/Test_CampsUI.py:48:8: W0212: Access to a protected member _CamposUi__crear_elementos of a client class (protected-access)
src/pygame_ui/CamposUI/Test_CampsUI.py:50:29: W0212: Access to a protected member _CamposUi__select_dado of a client class (protected-access)
src/pygame_ui/CamposUI/Test_CampsUI.py:52:29: W0212: Access to a protected member _CamposUi__text_triangulo of a client class (protected-access)
src/pygame_ui/CamposUI/Test_CampsUI.py:53:29: W0212: Access to a protected member _CamposUi__text_dado of a client class (protected-access)
src/pygame_ui/CamposUI/Test_CampsUI.py:54:29: W0212: Access to a protected member _CamposUi__text_turno of a client class (protected-access)
...
src/pygame_ui/CamposUI/Test_CampsUI.py:60:8: W0212: Access to a protected member _CamposUi__crear_elementos of a client class (protected-access)
src/pygame_ui/CamposUI/Test_CampsUI.py:61:8: W0212: Access to a protected member _CamposUi__crear_elementos of a client class (protected-access)
src/pygame_ui/CamposUI/Test_CampsUI.py:67:29: W0212: Access to a protected member _CamposUi__select_dado of a client class (protected-access)
src/pygame_ui/CamposUI/Test_CampsUI.py:110:12: W0212: Access to a protected member _CamposUi__crear_elementos of a client class (protected-access)
src/pygame_ui/CamposUI/Test_CampsUI.py:117:16: W0212: Access to a protected member _CamposUi__get_text_turno of a client class (protected-access)
src/pygame_ui/CamposUI/Test_CampsUI.py:122:16: W0212: Access to a protected member _CamposUi__get_text_turno of a client class (protected-access)
src/pygame_ui/CamposUI/Test_CampsUI.py:127:8: W0212: Access to a protected member _CamposUi__text_dado of a client class (protected-access)
src/pygame_ui/CamposUI/Test_CampsUI.py:128:8: W0212: Access to a protected member _CamposUi__text_turno of a client class (protected-access)
src/pygame_ui/CamposUI/Test_CampsUI.py:129:8: W0212: Access to a protected member _CamposUi__text_triangulo of a client class (protected-access)
src/pygame_ui/CamposUI/Test_CampsUI.py:130:8: W0212: Access to a protected member _CamposUi__dibujar_textos of a client class (protected-access)
src/pygame_ui/CamposUI/Test_CampsUI.py:135:8: W0212: Access to a protected member _CamposUi__select_dado of a client class (protected-access)
src/pygame_ui/CamposUI/Test_CampsUI.py:136:8: W0212: Access to a protected member _CamposUi__select_dado of a client class (protected-access)
src/pygame_ui/CamposUI/Test_CampsUI.py:141:8: W0212: Access to a protected member _CamposUi__select_dado of a client class (protected-access)
src/pygame_ui/CamposUI/Test_CampsUI.py:142:8: W0212: Access to a protected member _CamposUi__select_dado of a client class (protected-access)
src/pygame_ui/CamposUI/Test_CampsUI.py:152:16: W0212: Access to a protected member _CamposUi__get_text_fichas_comidas of a client class (protected-access)
src/pygame_ui/CamposUI/Test_CampsUI.py:157:16: W0212: Access to a protected member _CamposUi__get_text_fichas_comidas of a client class (protected-access)
src/pygame_ui/CamposUI/Test_CampsUI.py:179:8: W0212: Access to a protected member _CamposUi__select_dado of a client class (protected-access)
src/pygame_ui/CamposUI/Test_CampsUI.py:182:40: W0212: Access to a protected member _CamposUi__select_dado of a client class (protected-access)
...
src/core/models/backgammon/Test_Backgammon.py:486:44: C0303: Trailing whitespace (trailing-whitespace)
...
src/core/models/backgammon/backgammon.py:36:0: C0303: Trailing whitespace (trailing-whitespace)
src/core/models/backgammon/backgammon.py:48:0: C0303: Trailing whitespace (trailing-whitespace)
src/core/models/backgammon/backgammon.py:62:0: C0325: Unnecessary parens after 'not' keyword (superfluous-parens)
src/core/models/backgammon/backgammon.py:104:0: C0301: Line too long (103/100) (line-too-long)
src/core/models/backgammon/backgammon.py:156:0: C0301: Line too long (115/100) (line-too-long)
src/core/models/backgammon/backgammon.py:251:0: C0301: Line too long (156/100) (line-too-long)
src/core/models/backgammon/backgammon.py:253:0: C0301: Line too long (110/100) (line-too-long)
src/core/models/backgammon/backgammon.py:273:0: C0301: Line too long (107/100) (line-too-long)
src/core/models/backgammon/backgammon.py:310:0: C0304: Final newline missing (missing-final-newline)
src/core/models/backgammon/backgammon.py:60:11: C0123: Use isinstance() rather than type() for a typecheck. (unidiomatic-typecheck)
src/core/models/backgammon/backgammon.py:77:11: C0123: Use isinstance() rather than type() for a typecheck. (unidiomatic-typecheck)
src/core/models/backgammon/backgammon.py:79:16: R1716: Simplify chained comparison between the operands (chained-comparison)
src/core/models/backgammon/backgammon.py:91:8: R1703: The if statement can be replaced with 'return bool(test)' (simplifiable-if-statement)
src/core/models/backgammon/backgammon.py:91:8: R1705: Unnecessary "else" after "return", remove the "else" and de-indent the code inside it (no-else-return)
src/core/models/backgammon/backgammon.py:110:8: R1720: Unnecessary "else" after "raise", remove the "else" and de-indent the code inside it (no-else-raise)
src/core/models/backgammon/backgammon.py:181:4: R0914: Too many local variables (17/15) (too-many-locals)
